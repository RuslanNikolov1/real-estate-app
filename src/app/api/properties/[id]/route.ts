...
export async function GET(
  ...
  try {
    ...
    const transformedProperty = {
      ...
      price_per_sqm: (prop as any).price_per_sqm ? Number((prop as any).price_per_sqm) : undefined,
      ...
      bed_base: (prop as any).bed_base !== null && (prop as any).bed_base !== undefined ? Number((prop as any).bed_base) : undefined,
